...
class ApiManager{
  static Future<SourceResponse?> getCategorySources(String category)async{
    try {
  ...
  static Future<ArticleResponse?> getArticlesOfSource(String sourceId , int page)async{
    try{
  ...
  static Future<ArticleResponse?> getQueriedArticles(Source source , String query)async{
    try{
